...
function Navbar2(props) {
    ...
    const renderMenu = (
        <Menu anchorEl={anchorEl}
            ...
            <MenuItem>
                <a href="/createStream">Create Stream
                </a>
            </MenuItem>
    ...
    return (
        <div className={
            ...
            <div> {
                filtredData.slice(0, 10).map(e => (
                    <div > <a href={`/profile/${e._id}`}>{
                        e.username
                    }</a>
                        <img src={
                            e.imageUser
                ...
                <Toolbar>
                    <IconButton edge="start"
                        ...
                        <a href="/home">
                            ...
                            <img className="img-fluid logo" width="70" alt=""
                                src={logo}/>
                        </a>
                    ...
                    localStorage.getItem("token") !== null ? (
                        <div className={
                            ...
                            <IconButton edge="end" aria-label="account of current user"
                                ...
                                color="inherit">
                                <img alt="image" width="60px"
                                    src={imageUser}/> {username} </IconButton>
                        </div>
                    ) : (
...
const mapStateToProps = (state) => ({connected: state.connectedUser, users: state.users.users});
